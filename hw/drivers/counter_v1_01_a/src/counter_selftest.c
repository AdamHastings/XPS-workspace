/*****************************************************************************
* Filename:          /home/adam/RO-PUF/XPS_workspace/hw/drivers/counter_v1_01_a/src/counter_selftest.c
* Version:           1.01.a
* Description:       Contains a diagnostic self-test function for the counter driver
...
XStatus COUNTER_SelfTest(void * baseaddr_p)
{
  ...
  COUNTER_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = COUNTER_mReadSlaveReg0(baseaddr, 0);
  ...
  COUNTER_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = COUNTER_mReadSlaveReg1(baseaddr, 0);
  ...
  COUNTER_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = COUNTER_mReadSlaveReg2(baseaddr, 0);
