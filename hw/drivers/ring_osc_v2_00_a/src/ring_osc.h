/*****************************************************************************
* Filename:          /home/adam/RO-PUF/XPS_workspace/hw/drivers/ring_osc_v2_00_a/src/ring_osc.h
* Version:           2.00.a
 ...
 */
#define RING_OSC_SOFT_RST_SPACE_OFFSET (0x00000100)
#define RING_OSC_RST_REG_OFFSET (RING_OSC_SOFT_RST_SPACE_OFFSET + 0x00000000)
 ...
 * @note
 * C-style signature:
 * 	void RING_OSC_mReset(Xuint32 BaseAddress)
 *
 */
#define RING_OSC_mReset(BaseAddress) \
 	Xil_Out32((BaseAddress)+(RING_OSC_RST_REG_OFFSET), SOFT_RESET)
